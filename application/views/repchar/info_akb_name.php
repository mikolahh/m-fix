<div class="row" style="border: solid 2px; border-radius: 3px;">
	...
	<p style="font-size: 1.3em; margin-top: 5px;">
		В <?php echo $type_device_pp ?> используется аккумуляторная батарея <?php echo $batt_name ?>. Для ее замены необходима разборка <?php echo $type_device_rp ?>, что желательно делать в условиях мастерской.
